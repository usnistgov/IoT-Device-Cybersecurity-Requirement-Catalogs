...
<div class="toggle">
<label for="toggle1">Show Examples</label>
<input type="checkbox" onClick="openExamples()" id="toggle1" />
<span></span>
</div>
...
## 2). &nbsp;&nbsp;The procedures to support the ability for the manufacturer and/or supporting entity to notify customers of cybersecurity related events and information related to an IoT device throughout the support lifecycle. <br />
{: #Info2 }
